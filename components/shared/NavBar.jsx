  ...
  return (
    <div className="bg-transparent w-full">
      ...
      <div className="flex items-center">
        <a className="flex items-center text-dlightest text-decoration-none cursor-pointer py-2 px-6 bg-agreen rounded-lg hover:bg-white hover:text-agreen hover:border-agreen border border-solid gap-3" ><CiUser /><span>Account</span></a>
