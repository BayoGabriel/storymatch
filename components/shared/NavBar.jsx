  ...
  return (
    <nav className="flex justify-between items-center bg-transparent w-full px-6 py-2 mb-4">
      ...
      <div className="flex items-center">
        <a className="flex items-center text-dlightest text-decoration-none cursor-pointer py-2 px-6 bg-agreen rounded-lg hover:bg-white hover:text-agreen hover:border-agreen border border-solid gap-3 justify-center max" ><CiUser /><span>Account</span></a>
