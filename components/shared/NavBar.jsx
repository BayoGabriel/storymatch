  ...
  return (
    <nav className="flex justify-between items-center bg-transparent w-full px-6 py-2 mb-4">
      ...
      <div className="flex items-center justify-center gap-2">
        <a className="flex items-center text-dlightest text-decoration-none cursor-pointer py-2 px-6 bg-agreen rounded-lg hover:bg-white hover:text-agreen hover:border-agreen border border-solid gap-3 justify-center max-md:px-3 max-md:py-1" ><CiUser /><span>Account</span></a>
        ...
        {isMenuOpen && (
          <div className="lg:hidden z-40 flex rounded-20 flex-col items-center justify-center absolute top-20 left-1/2 transform -translate-x-1/2 bg-dlighter p-4 w-full">
          {Navlinks.map((item, index) => {
            return (
