            ...
            <Carousel leftControl=" " rightControl=" " indicators={false} pauseOnHover className='w-full h-full rounded-none  text-black'>
                ...
                <div className="flex w-full h-full  flex-col gap-8 ">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button className='text-white gap-4 bg-ddarker py-2 px-6 rounded-md flex items-center justify-center '><span className='p-2 bg-white rounded-full'><IoMailOpenOutline/></span> <span>Join with email</span></button>
