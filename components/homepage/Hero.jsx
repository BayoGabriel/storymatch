    ...
    <>
        <div className="w-full h-[89vh]">
            <Carousel leftControl=" " rightControl=" " indicators={false} pauseOnHover className='w-full h-full rounded-none  text-white'>
                <div className="grid grid-cols-2 max-lg:grid-cols-1 bg-red-300 items-center justify-center p-[30px]">
                <div className="flex w-full h-full  flex-col gap-8 ">
                    ...
                    <div className="flex gap-4 items-center">
                        <button className='text-white bg-darker py-2 px-6 rounded-md flex items-center ju'><FcGoogle/> <span>Join with google</span></button>
                        <button className='text-white bg-darker py-2 px-6 rounded-md flex items-center ju'><IoMailOpenOutline/> <span>Join with Email</span></button>
                    </div>
                </div>
