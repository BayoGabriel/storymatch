    ...
    <>
        <div className="w-full h-[89vh]">
            <Carousel leftControl=" " rightControl=" " indicators={false} pauseOnHover className='h-full'>
                <div className="w-full h-full idan rounded-none p-6 bg-red-200 text-black">
                    <div className="flex w-full h-full items-center justify-center bg-yellow-300 flex-col gap-8 my-10">
