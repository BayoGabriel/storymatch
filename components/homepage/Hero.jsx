        ...
        <div className="w-full h-[89vh]">
            <Carousel leftControl=" " rightControl=" " indicators={false} pauseOnHover className='w-full h-full rounded-none  text-black'>
                ...
                <div className="flex w-full h-full  flex-col gap-8 ">
                    ...
                    Instant Connection, h Endless Conversations
                    </h1>
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button className='text-white gap-4 bg-ddarker py-2 px-6 rounded-md flex items-center justify-center '><IoMailOpenOutline/> <span>Join with Email</span></button>
                    </div>
                </div>
